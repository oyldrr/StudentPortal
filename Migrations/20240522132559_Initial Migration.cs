        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OkulBaslangic = table.Column<DateOnly>(type: "date", nullable: false),
                    OkulBitis = table.Column<DateOnly>(type: "date", nullable: false),
                    OkulOrt = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
